...
<div class="container">
    <div class="row pt-4">
        <div class="col-md-4">
            <div class="item-menu my-activity hvr-grow">
            	<a href="${pageContext.request.contextPath}/MiActividadServlet" class="enlace"></a>
                <div class="item-title">&nbsp;&nbsp;Mi actividad</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="item-menu competencia hvr-grow">
            	<a href="${pageContext.request.contextPath}/CompetenciaServlet" class="enlace"></a>
                <div class="item-title">&nbsp;&nbsp;Competencia</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="item-menu settings hvr-grow">
                <a href="${pageContext.request.contextPath}/AjustesServlet" class="enlace"></a>
